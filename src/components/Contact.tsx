...
<div className="flex-1">
<h1 className="text-xl mb-3">Info</h1>
    <a
      href="#"
      onClick= {handleModal}
      className="flex gap-3 items-center hover:bg-slate-900 p-2 transition duration-300"
    ...
    <a
      ...
      className="flex gap-3 items-center hover:bg-slate-900 p-2 transition duration-300"
    >    
    Productos Digitales (BD)
    </a>
    
    {isModalOpen && (
        <div className="fixed top-0 left-0 right-0 bottom-0 transform  z-50 flex items-center justify-center ">
        <div
          style={{
            maxHeight: "70vh",
            overflowY: "scroll",
